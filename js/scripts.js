...
(function ($) {
	...
	$(function lienActifProjet(){

    $('#liensFiltre li').click(function(){
        $('#liensFiltre .active').removeClass('lienFiltreActif'); // remove the class from the currently selected
        $(this).addClass('lienFiltreActif'); // add the class to the newly clicked link
	...
	function dotClick() {
		$('#infos .owl-dot').click(function(){
        var element = $('#infos .owl-dot');	
